...
import speech_recognition as sr#3: pip install SpeechRecognition (this helps in taking the command from the user, and recognize the voice through microphone,converts speec to text from the microphone)
...
def wishme():
    speak("Welcome back Uttkarsh Sir, glad to  see you coming back")
...
while True:
        ...
        #for opening the VS code usig the voice command.
            ...
            codepath = '"C:\\Users\\Uttkarsh\\AppData\\Local\Programs\\Microsoft VS Code\\Code.exe"'
        ...
        #remeber execution.
            ...
            remember = open('data.txt','w')#jarivs will be storing the data in a txt fiile which he will read once asked by the user.
            remember.write(data)
            remember.close()
